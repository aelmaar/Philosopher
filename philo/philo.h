...
/*   Updated: 2023/03/10 12:24:15 by ael-maar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief Initialize the shared data between all philosophers before creating any threads.
...
/**
 * @brief write number to stderr.
*/
void		ft_putnbr_fd(int n, int fd);
/**
 * @brief convert ascii string to integer, it is an updated atoi function for the philosopher project.
 ...
 * @param pthread_num the number of the pthread in which it failed, whether threads or mutexes.
 * @param error_message the error message.
*/
void		pthread_error_message(int pthread_num, char *error_message);
/**
 * @brief Destroy the previous mutexes in case someone it's not initialized properly, and this is specific for forks.
 ...
 * @return return 0 if a philosopher not died or they still need to eat, otherwise return 1 in case one has died, or they were all eaten.
*/
